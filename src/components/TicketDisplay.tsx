...
import { DollarSign, AlertTriangle, Zap, Anchor, Sword } from 'lucide-react';
import { Ticket, RiskLevel, MatchLeg } from '../types'; 
...
const getStrategyColor = (strategy: RiskLevel) => {
    switch (strategy) {
        case RiskLevel.IronBank:
            return { tailwind: 'text-blue-400', hex: '#60a5fa' }; 
        case RiskLevel.BookieBasher:
            return { tailwind: 'text-neon-amber', hex: '#f59e0b' }; 
        case RiskLevel.HighYieldAssassin:
            return { tailwind: 'text-neon-red', hex: '#ef4444' }; 
        default:
...
const TicketCard: React.FC<{ ticket: Ticket }> = ({ ticket }) => {
    ...
    const chartData = [
        ...
        { name: 'Risk', value: 100 - (winProbability * 100), color: '#334155' },
    ];
